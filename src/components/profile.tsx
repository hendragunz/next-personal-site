        ...
        <div className="mt-6">
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            <a
              ...
              className="inline-flex items-center gap-x-2 rounded-lg border border-transparent bg-blue-600 px-6 py-4 font-medium text-white focus:outline-none focus:ring"
              target="blank">
              <svg
